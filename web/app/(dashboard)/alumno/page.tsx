...
const UPCOMING_TASKS = [
  ...
  { id: '2', titulo: 'Ensayo sobre Don Quijote de la Mancha', curso: 'Comunicación Integral', vencimiento: 'Viernes, 14:00', prioridad: 'media', color: '#1D1D1F' },
...
const CALENDAR_EVENTS = [
  { hora: '08:00 - 09:30', titulo: 'Matemática Divertida', aula: 'Aula 101', docente: 'María Gutiérrez', color: '#1D1D1F' },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div className="premium-card p-5">
          ...
          <div className="flex items-center gap-3 mt-3">
            <div className="h-10 w-10 bg-[#FFF0F1] text-[#1D1D1F] rounded-xl flex items-center justify-center">
            ...
            {CALENDAR_EVENTS.map((ev, index) => (
              <div key={index} className="flex gap-4 p-3 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
                <div className="flex flex-col items-center justify-center shrink-0">
                  <span className="text-[10px] font-black text-[#1D1D1F] bg-[#FFF0F1] px-2 py-1 rounded-lg">
                    {ev.hora.split(' ')[0]}
                  </span>
                </div>
